...
_defineProperty(XmlParser, "parser", new xmldom__namespace.DOMParser());
...
exports.ContentPartType = void 0;
...
class TemplateCompiler {
  ...
  detectContentType(tag, data) {
    ...
    // implicit - loop
    if (tag.disposition === exports.TagDisposition.Open || tag.disposition === exports.TagDisposition.Close) return this.options.containerContentType;
  ...
  findCloseTagIndex(fromIndex, openTag, tags) {
    ...
    for (; i < tags.length; i++) {
      const tag = tags[i];
      if (tag.disposition === exports.TagDisposition.Open) {
        openTags++;
        continue;
      }
      if (tag.disposition == exports.TagDisposition.Close) {
        openTags--;
        if (openTags === 0) {
          return i;
        }
